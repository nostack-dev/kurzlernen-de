...
try{
  ...
  const result=await page.evaluate(async()=>{
    ...
    const dataset={hp:viewport.dataset.vsLocalHealth,mate:viewport.dataset.vsPeerHealth,kills:viewport.dataset.vsKills,deaths:viewport.dataset.vsDeaths};bridge.stopVs();return{hitOk,shot,markerBefore,killed,peerRespawn,hpAfterFirst,hpAfterDuplicate,state,localDeath,dataset};
  });
