...
console.log("WORLD Box3D building collision passed: safe outdoor launch, stable ground-only AGL, projectile-query mask, swept camera-volume wall/ground/corner occlusion, unrelated wall contact and collider teardown.");
