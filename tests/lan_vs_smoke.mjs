...
console.log("LAN VS deterministic smoke passed: Trystero 0.25 callback API, parallel signaling, 0-GPS rendezvous, network diagnostics, 30 Hz timestamped position/velocity/frame poses, origin and combat.");
