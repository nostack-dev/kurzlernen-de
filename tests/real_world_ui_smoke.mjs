...
for(const marker of ["#086a9d","#2f7044","#ffd34f","#dbe4e9","WATER","GREEN","ROADS","BUILDINGS","OpenFreeMap extrusion lighting unavailable","fill-extrusion-vertical-gradient"])
