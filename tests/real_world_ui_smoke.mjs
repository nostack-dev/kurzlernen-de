...
try{
  ...
  console.log(`REAL WORLD E2E passed: exact FPV camera registration, shared north-up minimap, persisted 5-90 km/h GAME speed, 1:1 touch-coordinate firing, and a 32-slot depth-correct WORLD impact pool plus the recycled 32-mesh object/target decal pool.`);
