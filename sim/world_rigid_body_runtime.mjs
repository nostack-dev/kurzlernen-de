...
export const worldRigidBodyRuntime=Object.freeze({upsertBody,setTarget,clearTarget,removeBody,applyImpulse,pose,get ready(){return Boolean(ensureEngine());},get engine(){return ensureEngine();}});
