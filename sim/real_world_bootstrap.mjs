...
class RealWorldBridge{
  ...
  async activate(){
    ...
    try{
      ...
      this.lastMapSyncMs=-Infinity;this.lastMapView=null;this.mapUpdates=0;this.perfWindowStart=performance.now();this.perfFrames=0;this.perfGoodWindows=0;this.perfMode="nominal";this.mapFrameMs=WORLD_MAP_FRAME_MS;this.mapPerfWindowStart=performance.now();this.mapPerfFrames=0;this.mapRenderFps=60;
