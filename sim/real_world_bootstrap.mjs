...
class RealWorldBridge{
  ...
  setImageryEnabled(value){
    this.imageryEnabled=Boolean(value);try{localStorage.removeItem(WORLD_IMAGERY_STORAGE);}catch{}
