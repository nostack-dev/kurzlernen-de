...
class RealWorldBridge{
  ...
  deactivate(){
    this.active=false;this.loading=false;this.lastMapSyncFrameSerial=-1;this.resetLook(true);if(this.geoContainer)this.geoContainer.hidden=true;if(this.threeRenderer){this.threeRenderer.domElement.style.visibility="visible";this.threeRenderer.domElement.style.display="block";this.threeRenderer.setClearAlpha(1);if(this.flightPixelRatio!==null)this.threeRenderer.setPixelRatio(this.flightPixelRatio);if(this.flightShadowEnabled!==null)this.threeRenderer.shadowMap.enabled=this.flightShadowEnabled;}if(this.threeScene){this.restoreTrainingWorld();this.threeScene.traverse(node=>{if(node.userData?.flightFireDecal&&node.userData.flightFireWorld)node.visible=false;});if(this.savedBackground!==null)this.threeScene.background=this.savedBackground;if(this.savedFog!==null)this.threeScene.fog=this.savedFog;}
