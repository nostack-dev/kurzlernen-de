...
function installStyle(){
  ...
  style.dataset.walkUiLayoutHotfix="rest-v2";
  style.textContent=`
    ...
    body.solo-flight.on-foot-mode #worldLookHud.expanded{z-index:40!important}
    ...
    @media(max-width:1100px){
      ...
      body.solo-flight.on-foot-mode #worldLookHud:not(.expanded){width:108px!important;height:108px!important;right:max(8px,var(--solo-safe-right,env(safe-area-inset-right)))!important;top:max(52px,calc(var(--solo-safe-top,env(safe-area-inset-top)) + 46px))!important}
    ...
    @media(max-width:900px){
      ...
      body.solo-flight.on-foot-mode #worldLookHud:not(.expanded){width:100px!important;height:100px!important}
