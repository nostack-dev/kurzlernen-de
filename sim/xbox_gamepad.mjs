...
function neutralSample(gamepad){
  return Object.freeze({id:String(gamepad.id||"Xbox controller"),index:Number(gamepad.index)||0,left:Object.freeze({x:0,y:0}),right:Object.freeze({x:0,y:0}),leftTrigger:0,rightTrigger:0,heightAxis:0,aim:false,fire:false,arm:false,kill:false,camera:false,target:false,scheme:loadXboxControlScheme()});
}
...
export function sampleXboxGamepad(gamepad){
  ...
  const scheme=loadXboxControlScheme();
  const aim=scheme===XBOX_CONTROL_SCHEMES.AIM&&buttonValue(gamepad,XBOX_STANDARD_BUTTON.LEFT_SHOULDER)>.5;
