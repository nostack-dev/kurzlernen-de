...
function mountSoloWorldSettings({parent,dialog,settingsButton}){
  ...
  const section=document.createElement("section");section.className="world-settings-section";section.dataset.worldSettings="openfreemap-osm-3d";section.innerHTML=`
    ...
    <p class="phone-settings-note">Imagery and OSM map/building data are render/geospatial context only. Motor, sensor, FC and rigid-body physics stay on the same hardware-fit digital-twin path; map geometry is not collision truth.</p>`;
