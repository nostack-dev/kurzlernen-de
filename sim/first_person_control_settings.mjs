...
export function normalizeFirstPersonControlSettings(settings={}){
  return{
    ...
    aimMagnifierEnabled:settings.aimMagnifierEnabled===undefined?DEFAULT_FIRST_PERSON_CONTROL_SETTINGS.aimMagnifierEnabled:Boolean(settings.aimMagnifierEnabled),
